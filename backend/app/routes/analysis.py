...
def preview(payload: AnalysisCreate):
    ...
    online = search_public_team_info(payload.team_name)
    if selected_team is None:
        return {
            "team_found": False,
            "team": {
            ...
            "pre_analysis": {
                ...
                "recommended_focus": [
                    ...
                    "Coletar elenco e ultimos jogos",
                    "Mapear modelo tatico antes de salvar como dossie",
                ],
                "graph_insights": [
                ...
                "operational_research_insights": [
                    "Aguardar dados de elenco para otimizar formacao",
                    "Definir objetivo do jogo antes de comparar estrategias",
                ],
            },
            "save_ready": False,
        }
