...
DEFAULT_LLM_CONFIG = {
    ...
    "max_tools": 16,
    "max_frames": 8,
    "context_limit_bytes": 128000,
    "result_limit_bytes": 32000,
    # Empty means provider fallback is disabled. Local deterministic behavior
    # remains the terminal safe path regardless of this list.
    "fallback_order": [],
    "language": "pt-BR",
...
def public_llm_config() -> dict:
    ...
    return {
        ...
        "context_limit_bytes": config.get("context_limit_bytes"),
        "result_limit_bytes": config.get("result_limit_bytes"),
